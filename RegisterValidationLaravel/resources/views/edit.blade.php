...
<form method="post" action="/edit/{{$student['userid']}}">
@csrf
  <div class="form-group">
    <label for="UserName">Username</label>
    <input type="text" class="form-control" id="email" name="fullname" value="{{$student['fullname']}}">
  </div>
  @error('fullname')
          <div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="email" name="mobile" value="{{$student['mobile']}}">
  </div>
  @error('mobile')
          <div>
            <p style="color: red;font-size:1rem">{{$message}}</p>
